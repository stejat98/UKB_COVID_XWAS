...
covid_hosp_ewas_baseline_covariates_adjusted_results_df  <- readRDS("/home/st320/UKB_COVID_XWAS/covid_hosp_ewas_07_17_2020_glm_results_04_20_22.RDS")
...
covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- covid_hosp_ewas_baseline_covariates_adjusted_results_df[-grep(".y",covid_hosp_ewas_baseline_covariates_adjusted_results_df$Exposure),]

covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered %>% filter(!term %in% unique(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$term)[c(1,3:78)])
...
saveRDS(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered, "UKB_COVID_XWAS/covid_hosp_ewas_07_17_2020_results_updated_05_04_2022_filtered_process.RDS")


covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered %>% filter(SampleSize < 200)

covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered %>% filter(SampleSize > 200)
...
biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22 <- readRDS("/home/st320/UKB_COVID_XWAS/biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_glm_results_05_02_22.RDS")
biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22$RiskRatio <- exp(biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22$estimate)
biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22_filtered <- biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22 %>% filter(!term %in% unique(biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22$term)[c(1,3:78)])

biomarkers_first_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22 <- biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22_filtered[grep("first",biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22_filtered$Exposure),]
biomarkers_first_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22$measurement <- "first"
biomarkers_last_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22 <- biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22_filtered[grep("last",biomarkers_first_last_measurements_covid_hosp_ewas_07_17_2020_poisson_log_glm_results_05_02_22_filtered$Exposure),]
biomarkers_last_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22$measurement <- "last"

covid_hosp_ewas_07_17_2020_results_filtered_process <- readRDS("UKB_COVID_XWAS/covid_hosp_ewas_07_17_2020_results_updated_05_04_2022_filtered_process.RDS")
biomarkers_median_07_17_2020_results <- covid_hosp_ewas_07_17_2020_results_filtered_process[grep("median",covid_hosp_ewas_07_17_2020_results_filtered_process$Exposure),]
biomarkers_median_07_17_2020_results$measurement <- "median"

biomarkers_first <- biomarkers_first_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22 %>% select(c(Exposure,RiskRatio)) %>% rename(RiskRatio_f = RiskRatio)
biomarkers_last <- biomarkers_last_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22 %>% select(c(Exposure, RiskRatio)) %>% rename(RiskRatio_l = RiskRatio) 
biomarkers_median <- biomarkers_median_07_17_2020_results %>% select(c(Exposure, RiskRatio)) %>% rename(RiskRatio_m = RiskRatio)
...
pdf("UKB_COVID_XWAS/scatterplot_median_first_measurement_07_17_2020_hosp_ewas_results_05_02_22.pdf")
ggplot(aes(x = RiskRatio_m, y = RiskRatio_f), data = biomarkers_all) + geom_point() + xlab("Risk Ratio (median of measurements)") + ylab("Risk Ratio (first measurement)")
dev.off()

pdf("UKB_COVID_XWAS/scatterplot_median_last_measurement_07_17_2020_hosp_ewas_results_05_02_22.pdf")
ggplot(aes(x = RiskRatio_m, y = RiskRatio_l), data = biomarkers_all) + geom_point() + xlab("Risk Ratio (median of measurements)") + ylab("Risk Ratio (last measurement)") + ylim(0,1.5)
dev.off()

biomarkers_first_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22 <-biomarkers_first_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22 %>% select(-measurement)
covid_hosp_ewas_07_17_2020_results_filtered_process <- covid_hosp_ewas_07_17_2020_results_filtered_process %>% select(-c(Bonferroni, FDR))

covid_hosp_ewas_07_17_2020_results_filtered_process <- covid_hosp_ewas_07_17_2020_results_filtered_process[-grep("median",covid_hosp_ewas_07_17_2020_results_filtered_process$Exposure),]
covid_hosp_ewas_07_17_2020_results_filtered_process <- rbind(covid_hosp_ewas_07_17_2020_results_filtered_process,biomarkers_first_measurement_covid_hosp_ewas_07_17_2020_results_05_02_22)
covid_hosp_ewas_07_17_2020_results_filtered_process$AUC <- as.numeric(covid_hosp_ewas_07_17_2020_results_filtered_process$AUC)
covid_hosp_ewas_07_17_2020_results_filtered_process$AUCadjVariables <- as.numeric(covid_hosp_ewas_07_17_2020_results_filtered_process$AUCadjVariables)

covid_hosp_ewas_07_17_2020_results_filtered_process$deltaAUC <- covid_hosp_ewas_07_17_2020_results_filtered_process$AUC - covid_hosp_ewas_07_17_2020_results_filtered_process$AUCadjVariables

covid_hosp_ewas_07_17_2020_results_filtered_process <- covid_hosp_ewas_07_17_2020_results_filtered_process %>% mutate(Bonferroni = p.adjust(p.value1,method ="bonferroni"))
covid_hosp_ewas_07_17_2020_results_filtered_process <- covid_hosp_ewas_07_17_2020_results_filtered_process %>% mutate(FDR = p.adjust(p.value1,method ="fdr"))



getpropSig <- function(threshold){
  numSig <- covid_hosp_ewas_07_17_2020_results_filtered_process %>% filter(FDR < (threshold/100)) %>% nrow()
  prop = numSig/nrow(covid_hosp_ewas_07_17_2020_results_filtered_process)
  return(prop)
}
...
pdf("/home/st320/UKB_COVID_XWAS/plot_threshold_props_sig_07_17_2020_hosp_ewas_results_05_02_22.pdf")
ggplot(aes(x = thresholds, y = props), data = data_props_thresholds) + geom_bar(stat = "identity") + xlab("FDR Threshold (%)") + ylab ("Proportion of significant findings")
dev.off()
...
covid_hosp_ewas_07_17_2020_results_filtered_process <- covid_hosp_ewas_07_17_2020_results_filtered_process %>% filter(SampleSize > 200)



covid_hosp_ewas_fdr_10_pct_results <- covid_hosp_ewas_07_17_2020_results_filtered_process %>% filter(FDR < quantile(FDR, 0.1, na.rm = T)) 

saveRDS(covid_hosp_ewas_fdr_10_pct_results, "/home/st320/UKB_COVID_XWAS/covid_hosp_ewas_fdr_10_pct_results_withdeltaAUC_07_17_2020.RDS")
covid_hosp_ewas_fdr_10_pct_results <- readRDS("/home/st320/UKB_COVID_XWAS/covid_hosp_ewas_fdr_10_pct_results_withdeltaAUC_07_17_2020.RDS")
...
saveRDS(covid_hosp_ewas_fdr_10_pct_results, "/home/st320/UKB_COVID_XWAS/covid_hosp_ewas_fdr_10_pct_results_withdeltaAUC_07_17_2020_results_05_02_22.RDS")

covid_hosp_ewas_fdr_10_pct_results <- covid_hosp_ewas_fdr_10_pct_results %>% arrange(FDR)

write_csv(covid_hosp_ewas_fdr_10_pct_results, "/home/st320/UKB_COVID_XWAS/covid_hosp_ewas_fdr_10_pct_results_withdeltaAUC_07_17_2020_results_05_02_22.csv")
...
top_factors_10_pct <-  top_factors_10_pct %>% select(Exposure,`Risk Ratio [95% CI]`, `p-value`, FDR,AUC, AUCadjVariables, deltaAUC, SampleSize)
top_factors_10_pct <- top_factors_10_pct %>% arrange(FDR)
write_csv(top_factors_10_pct, "UKB_COVID_XWAS/hosp_ewas_top_factors_10_pct_07_17_2020_05_09_22.csv")
...
covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- readRDS("UKB_COVID_XWAS/covid_hosp_ewas_07_17_2020_results_updated_05_04_2022_filtered_process.RDS")
...
covid_hosp_ewas_fdr_10_pct_results <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered %>% filter(FDR < quantile(FDR, 0.1, na.rm = T)) %>% arrange(FDR)

saveRDS(covid_hosp_ewas_fdr_10_pct_results, "/home/st320/UKB_COVID_XWAS/covid_hosp_ewas_07_17_2020_results_updated_05_04_2022_ewas_fdr_10_pct_results_withdeltaAUC_07_17_2020.RDS")
...
covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered  <- left_join(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered,exposures_id_name_mapping_updated,by=c("Exposure"="variableName"))
covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- left_join(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered,ukb_pheno_id_name_mapping,by = c("Exposure" = "Phenotype_id"))
covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- left_join(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered,ukb_health_disease_factors_mapping,by = c("Exposure" = "health_disease_var"))

covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure_Name[grep("INT_median_50",covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure):grep("INT_median_102", covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure)] <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Name.x[grep("INT_median_50",covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure):grep("INT_median_102", covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure)]

covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure_Name[grep("x_2178",covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure):grep("x_6152_9", covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure)] <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Name.y[grep("x_2178",covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure):grep("x_6152_9", covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered$Exposure)]
covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered[,-c(grep("Category",colnames(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered)):grep("Name.y",colnames(covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered)))]


hosp_forest_plot_df <- covid_hosp_ewas_baseline_covariates_adjusted_results_df_filtered %>% arrange(FDR) %>% filter(SampleSize > 100)
...
write_csv(FDR_0.1_sig_exposures,"UKB_COVID_XWAS/hosp_FDR_0.1_sig_exposures_07_17_20_updated_09_15.csv")

hosp_forest_plot_df$Significance <- ifelse(hosp_forest_plot_df$FDR < 0.1, "FDR < 0.1", "FDR > 0.1")

pdf("UKB_COVID_XWAS/hosp_volcano_plot_07_17_20_updated_09_15.pdf")
ggplot(aes(x= RiskRatio, y = -log10(FDR), col = Significance),data=hosp_forest_plot_df) + geom_point() + xlim(0.7,1.2) + ylim(0,3.75) +
  geom_text_repel(data = subset(hosp_forest_plot_df, Significance == "FDR < 0.1"),aes(label = Exposure_Name),colour = "black",segment.size = 0.1, size = 1.5) + xlab("RR") + ylab(expression(-log[10](`FDR`)))
dev.off()
