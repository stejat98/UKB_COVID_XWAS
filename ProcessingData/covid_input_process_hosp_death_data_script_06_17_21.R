...
hesin_diag_table <- read_delim("hesin_diag_020721.txt",delim = "\t")


## load covid test positivity data
covid_data <- read_delim("covid19_result_2_2021.txt",delim = "\t")
...
covid_ukb9512_full_40GPCs_updated <- readRDS("covid_ukb9512_full_40GPCs_updated_06_17_21.RDS")
...
saveRDS(covid_ukb9512_full_40GPCs_updated_age_data,"covid_hosp_status_ukb9512_full_40GPCs_updated_06_17_21.RDS")

covid_ukb9512_full_40GPCs_updated_age_data <- readRDS("covid_hosp_status_ukb9512_full_40GPCs_updated_06_17_21.RDS")

death_cause_data <- read_delim("death_cause_020721.txt",delim = "\t")
...
saveRDS(covid_ukb9512_full_40GPCs_updated_age_data,"covid_death_ukb9512_full_40GPCs_updated_06_17_21.RDS")
...
saveRDS(data,"covid_death_ukb9512_full_40GPCs_updated_06_17_21.RDS")
