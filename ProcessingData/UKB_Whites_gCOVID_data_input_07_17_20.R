...
covid_data <- read_delim("/n/groups/patel/uk_biobank/covid_death_071720/22881/covid19_result_071720.txt",delim = "\t")
...
saveRDS(covid_ukb9512_full_40GPCs,"/n/scratch3/users/s/st320/UKB_COVID_XWAS/covid_ukb9512_full_40GPCs_07_17_20.RDS")


## updated 07/16/2020

covid_ukb9512_full_40GPCs <- readRDS("/n/scratch3/users/s/st320/UKB_COVID_XWAS/covid_ukb9512_full_40GPCs_07_17_20.RDS")
...
saveRDS(ukb34521_health_covars_data_filtered,"/n/groups/patel/sivateja/UKB/COVID19/ukb34521_health_covars_data_filtered.RDS")
...
ukb34521_health_covars_data_filtered_proc <- readRDS("/n/scratch3/users/s/st320/ukb34521_health_covars_data_filtered_proc.RDS")
saveRDS(ukb34521_health_covars_data_filtered_proc, "/n/groups/patel/sivateja/UKB/COVID19/ukb34521_health_covars_data_filtered_proc.RDS")

ukb34521_health_covars_data_filtered_proc <- readRDS("/n/groups/patel/sivateja/UKB/COVID19/ukb34521_health_covars_data_filtered_proc.RDS")
...
saveRDS(covid_ukb9512_full_40GPCs_updated ,"/n/groups/patel/sivateja/UKB/COVID19/covid_ukb9512_full_40GPCs_updated_07_17_20.RDS")
...
save(ukb_exposures_covid,file="/n/groups/patel/sivateja/UKB/COVID19/ukb_exposures_covid.RData")
...
save(all_baseline_col_names_covid_xwas,file="/n/groups/patel/sivateja/UKB/COVID19/all_baseline_col_names_covid_xwas.RData")
